...
public struct FlowingIconButton: View {
  ...
  private var hoverDuration: TimeInterval {
    reduceMotion ? FlowingMotion.reducedHover : FlowingMotion.hover
  }
}
...
private struct FlowingIconButtonStyle: ButtonStyle {
  ...
  private var foreground: Color {
    ...
    case .quiet, .standard:
      isSelected || isHovering ? accent.foreground : FlowingPalette.muted
    }
  }
  ...
  private var border: Color {
    ...
    case .standard:
      isSelected ? accent.fill.opacity(0.24) : FlowingPalette.hairline
